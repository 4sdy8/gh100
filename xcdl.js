var p_w="88px";  //广告宽度,单位px,如自适应宽度就改为100%;
var p_h="88px";    //广告高度,单位px
var p_s="https://img13.360buyimg.com/ddimg/jfs/t1/186545/34/14555/2409260/60fab8b7E42048a67/623837c2f7a76965.gif";  //广告图片地址
var p_l="https://go.tumhcxn.cn/11928195?tmp=wyc";  //广告图片链接
function closeWin(){
	var box=document.getElementById("f_f");
	box.parentNode.removeChild(box);
}
document.writeln("<style type=\"text/css\">");
document.writeln(".f_f{ width:100%; position:fixed; left:72%;top:55%;width:"+p_w+"; height:"+p_h+"; bottom:0px; z-index:9999;}");
